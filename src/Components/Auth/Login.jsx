    ...
    const onGoogleSignIn = (e) => {
        ...
        if (!isSigningIn) {
            ...
            doSignInWithGoogle().catch(err => {
                setErrorMessage('Error al iniciar sesión con Google: ' + err.message)
                setIsSigningIn(false)
            })
        }
    }
        ...
        <div>
            ...
            <main className="w-full py-12 flex self-center place-content-center place-items-center">
                <div className="w-96 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl">
                    ...
                    <p className="text-center text-sm">¿No tienes una cuenta? <Link to={'/register'} className="hover:underline font-bold">Regístrate</Link></p>
