...
import { doCreateUserWithEmailAndPassword, doRegisterWithGoogle } from "../../Firebase/auth"
...
const Register = () => {
    ...
    const onGoogleRegister = (e) => {
        ...
        if (!isRegistering) {
            setIsRegistering(true)
            doRegisterWithGoogle().catch(err => {
                setErrorMessage('Error al registrarse con Google: ' + err.message)
                setIsRegistering(false)
            })
        }
    }
    ...
    return (
        <>
            ...
            <main className="w-full py-12 flex self-center place-content-center place-items-center">
                <div className="w-96 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl">
                    ...
                    <button
                        ...
                        {isRegistering ? 'Registrando...' : 'Registrarse con Google'}
                    </button>
                </div>
            </main>
        </>
